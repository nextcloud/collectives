...
export const SECOND_CONTENT = INITIAL_CONTENT
...
export const REVIEWED_CONTENT = INITIAL_CONTENT
...
export const INITIAL_PHRASE = '10% pilot cohort'
export const REVIEWED_PHRASE = '15% reviewed cohort'
export const CURRENT_PHRASE = '25% progressive rollout'

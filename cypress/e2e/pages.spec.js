...
describe('Pages', function() {
	...
	describe('visited from collective home', function() {
		it('Shows the title in the enabled titleform', function() {
			...
			cy.get('.page-title-container input').should('have.value', 'Day 1')
			cy.get('.page-title-container input').should('not.have.attr', 'disabled')
		})
	})
	...
	describe('Set page emoji', function() {
		it('Allows setting a page emoji from title bar', function() {
			cy.openPage('Day 1')
			cy.get('.page-title-container .page-title-icon')
				.click()
			...
			cy.reload()
			cy.get('.page-title-container .page-title-icon .emoticon-outline-icon')
			cy.contains('.app-content-list-item', 'Day 1')
	...
	describe('With special chars', function() {
		it('loads well', function() {
			...
			cy.get('.page-title-container input').should('have.value', '#% special chars')
		})
	})
	...
	describe('Creating a page from template', function() {
		it('New page has template content', function() {
			...
			cy.get('.page-title-container input.title')
	...
	describe('Creating a new subpage', function() {
		it('Shows the title in the enabled titleform and full path in browser title', function() {
			...
			cy.get('.page-title-container input').should('have.value', 'Subpage Title')
			cy.get('.page-title-container input').should('not.have.attr', 'disabled')
	...
	describe('Full width view', function() {
		it.only('Allows to toggle persistent full-width view', function() {
			cy.openPage('Day 2')
			cy.get('.page-title-container').should('have.class', 'sheet-view')
			cy.getReadOnlyEditor()
			...
			cy.contains('li.action', 'Full width')
				.click()
			cy.get('.page-title-container').should('have.class', 'full-width-view')
			cy.getReadOnlyEditor()
				.find('.editor__content')
				.invoke('outerWidth')

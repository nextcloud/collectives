...
* Some content
	...
	const testLinkToViewer = function(href, { fileName, viewerFileElement, edit = false }) {
		...
		cy.get(`.viewer__content ${viewerFileElement}`).should('exist')
	...
	it('View mode: Opens link with absolute path to image in Nextcloud in viewer', function() {
		const href = `/index.php/f/${imageId}`
		testLinkToViewer(href, { fileName: 'test.png', viewerFileElement: 'img' })
	})
	it('View mode: Opens link with absolute path to text file in Nextcloud in viewer', function() {
		const href = `/index.php/f/${textId}`
		testLinkToViewer(href, { fileName: 'test.md', viewerFileElement: '[data-text-el="editor-container"]' })
	})
	it('View mode: Opens link with relative path to pdf in Nextcloud in viewer', function() {
		const href = `/index.php/f/${pdfId}`
		testLinkToViewer(href, { fileName: 'test.pdf', viewerFileElement: 'iframe' })
	})

	it('Edit mode: Opens link with absolute path to image in Nextcloud in viewer', function() {
		const href = `/index.php/f/${imageId}`
		cy.switchToEditMode()
		testLinkToViewer(href, { fileName: 'test.png', viewerFileElement: 'img', edit: true })
	})
	it('Edit mode: Opens link with absolute path to text file in Nextcloud in viewer', function() {
		const href = `/index.php/f/${textId}`
		cy.switchToEditMode()
	...
	it('Edit mode: Opens link with relative path to pdf in Nextcloud in viewer', function() {
		const href = `/index.php/f/${pdfId}`
		cy.switchToEditMode()
		testLinkToViewer(href, { fileName: 'test.pdf', viewerFileElement: 'iframe', edit: true })
	})

	it('View mode: Opens link with slugified URL to page in this collective in same tab', function() {
	...
	it('View mode: Opens link with URL to page in this collective in same tab', function() {
		const href = `${baseUrl}/index.php/apps/collectives/Link%20Testing/Link%20Target`
		testLinkToSameTab(href, {
			expectedPathname: `/index.php/apps/collectives/Link-Testing-${linkTestingCollectiveId}/Link-Target-${linkTargetPageId}`,
		})
	})
	it('View mode: Opens link with absolute path to page in this collective in same tab', function() {
		const href = '/index.php/apps/collectives/Link%20Testing/Link%20Target'
		testLinkToSameTab(href, {
			expectedPathname: `/index.php/apps/collectives/Link-Testing-${linkTestingCollectiveId}/Link-Target-${linkTargetPageId}`,
		})
	})
	it('View mode: Opens link with relative path to page in this collective with fileId in same tab', function() {
	...
	it('View mode: Opens link with relative path to page in this collective with fileId and outdated path in same tab', function() {
	...
	it('View mode: Opens link with relative path to page in this collective without fileId in same tab', function() {
		const href = './Link%20Target'
		testLinkToSameTab(href, {
			expectedPathname: `/index.php/apps/collectives/Link-Testing-${linkTestingCollectiveId}/Link-Target-${linkTargetPageId}`,
		})
	})
	it('View mode: Opens link with relative path to markdown file in this collective without fileId in same tab', function() {
	...
	it('View mode: Opens link with URL to page in other collective with fileId in same tab', function() {
	...
	it('View mode: Opens link with absolute path to page in other collective without fileId in same tab', function() {
	...
	it('Edit mode: Opens link with slugified URL to page in this collective in same tab', function() {
		const href = `${baseUrl}/index.php/apps/collectives/Link-Testing-${linkTestingCollectiveId}/Link-Target-${linkTargetPageId}`
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with URL to page in this collective in same tab', function() {
		const href = `${baseUrl}/index.php/apps/collectives/Link%20Testing/Link%20Target`
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with absolute path to page in this collective in same tab', function() {
		const href = '/index.php/apps/collectives/Link%20Testing/Link%20Target'
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with relative path to page in this collective with fileId in same tab', function() {
		const href = `./Link%20Target?fileId=${linkTargetPageId}`
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with relative path to page in this collective with fileId and outdated path in same tab', function() {
		const href = `./Link%20Target%20Outdated?fileId=${linkTargetPageId}`
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with relative path to page in this collective without fileId in same tab', function() {
		const href = './Link%20Target'
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with relative path to markdown file in this collective without fileId in same tab', function() {
		const href = './Link%20Target.md'
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with URL to page in other collective with fileId in same tab', function() {
		const href = `${baseUrl}/index.php/apps/collectives/Another%20Collective/First%20Page?fileId=${anotherCollectiveFirstPageId}`
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('Edit mode: Opens link with absolute path to page in other collective without fileId in same tab', function() {
		const href = '/index.php/apps/collectives/Another%20Collective/First%20Page'
		cy.switchToEditMode()
		testLinkToSameTab(href, {
			edit: true,
	...
	it('View mode: Opens link with URL to another Nextcloud app in new tab', function() {
		const href = `${baseUrl}/index.php/apps/contacts`
		testLinkToNewTab(href)
	})
	it('View mode: Opens link with absolute path to another Nextcloud app in new tab', function() {
		const href = '/index.php/apps/contacts'
		testLinkToNewTab(href)
	})

	it('Edit mode: Opens link with URL to another Nextcloud app in new tab', function() {
		const href = `${baseUrl}/index.php/apps/contacts`
		cy.switchToEditMode()
		testLinkToNewTab(href, { edit: true })
	})
	it('Edit mode: Opens link with absolute path to another Nextcloud app in new tab', function() {
		const href = '/index.php/apps/contacts'
		cy.switchToEditMode()
		testLinkToNewTab(href, { edit: true })
	})

	it('View mode: Opens link to external website in new tab', function() {
		const href = 'https://github.com/'
		testLinkToNewTab(href)
	})
	it('View mode: Opens link to foreign Collectives page in new tab', function() {
		const href = 'https://github.com/apps/collectives/Foreign%20Collective/Foreign%20Page?fileId=123'
		testLinkToNewTab(href)
	})

	it('Edit mode: Opens link to external website in new tab', function() {
		const href = 'https://github.com/'
		cy.switchToEditMode()
		testLinkToNewTab(href, { edit: true })
	})
	it('Edit mode: Opens link to foreign Collectives page in new tab', function() {
		const href = 'https://github.com/apps/collectives/Foreign%20Collective/Foreign%20Page?fileId=123'
		cy.switchToEditMode()
		testLinkToNewTab(href, { edit: true })
	})

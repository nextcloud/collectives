...
describe('Collective', function() {
	...
	describe('name conflicts', function() {
		...
		it('creates collectives by picking team',
			function() {
				...
				cy.get('.page-title-container input').invoke('val').should('contain', 'History Club')
		...
		it('creates collectives for admins of corresponding team',
			function() {
				...
				cy.get('.page-title-container input').invoke('val').should('contain', 'Preexisting Team')
				cy.get('.toast-info').should('contain',
	...
	describe('non ascii characters', function() {
		it('can handle special chars in collective name',
			function() {
				...
				cy.get('.page-title-container input').invoke('val').should('contain', specialCollective)
			})
	...
	describe('after creation', function() {
		...
		it('has all the ui elements', function() {
			...
			cy.get('.page-title-container input').invoke('val').should('contain', randomName)
	...
	describe('reloading works', function() {
		before(function() {
			cy.loginAs('bob')
			cy.visit('/apps/collectives/Preexisting%20Collective')
			cy.get('.page-title-container input').should('have.value', 'Preexisting Collective')
		})

	...
	methods: {
		...
		scrollToLocationHash() {
			if (document.location.hash) {
				...
				const readerElement = document.querySelector('[data-collectives-el="reader"]')
				const editorElement = document.querySelector('[data-collectives-el="editor"]')
				for (const el of [readerElement, editorElement]) {
					el?.querySelector(`[href="${document.location.hash}"]`)?.click()
				}
			}
		},

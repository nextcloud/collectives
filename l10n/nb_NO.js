OC.L10N.register(
    "collectives",
    {
    "Collectives" : "Gemenskaper",
    "Collectives: page content" : "Gemenskapsside",
    "in page {page} from collective {collective}" : "Slett gemenskape «{collective}» for godt?",
    "Collectives: pages" : "Gemenskapsside",
    "in Collective {collective}" : "i {collective}",
    "Created collective \"%s\" for existing circle." : "Opprettet gemenskapen «%s» for eksisterende sirkel.",
    ...
    "Collectives is a Nextcloud App for activist and community projects to organize together.\nCome and gather in collectives to build shared knowledge.\n\n* 👥 **Collective and non-hierarchical workflow by heart**: Collectives are\n  tied to a [Nextcloud Circle](https://github.com/nextcloud/circles) and\n  owned by the collective.\n* 📝 **Collaborative page editing** like known from Etherpad thanks to the\n  [Text app](https://github.com/nextcloud/text).\n* 🔤 **Well-known [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax**\n  for page formatting.\n\n## Installation\n\nIn your Nextcloud instance, simply navigate to **»Apps«**, find the\n**»Circles«** and **»Collectives«** apps and enable them." : "Gemenskaper er et Nextcloud-program tiltenkt organisering av aktivist- og gemenskapsprosjekter.\nKnytt deg til fellesskap i gemenskaper for å bygge delt kunnskap.\n* 👥 **Gemenskapsdrevet grasrotsarbeidsflyt**: Gemenskaper er\n  knyttet til en [Nextcloud-sirkel](https://github.com/nextcloud/circles) og\n  eid av gemenskapen.\n* 📝 **Samarbeidsredigering av sider** som på Etherpad, takket være\n  [Tekst-programmet](https://github.com/nextcloud/text).\n* 🔤 **Velkjent [Markdown](https://en.wikipedia.org/wiki/Markdown)-syntaks**\n  for sideformatering.\n\n##Installasjon\n\nI din Nextcloud-instans går du til **«Programmer»**, finner\n**«Sirkler»** og **«Gemenskaper»**-programmene og skrur dem på.",
    "Deleted collectives" : "Slettede gemenskaper",
    "Restore" : "Gjenopprett",
    "Delete permanently" : "Slett for godt",
    "Permanently delete collective »{collective}«" : "Slett gemenskape «{collective}» for godt?",
    "Delete corresponding circle along with the collective?" : "Slett motsvarende sirkel sammen med gemenskapen?",
    "Cancel" : "Avbryt",
    "Only collective" : "Kun gemenskapen",
    "Collective and circle" : "Gemenskapen og sirkelen",
    "Last edited by {user}" : "Sist endret av {user}",
    "Select a collective" : "Velg en gemenskap",
    "Delete" : "Slett",
    "Create new collective" : "Opprett ny gemenskap",
    "Create collective for existing circle" : "Opprett gemenskap for eksisterende sirkel",
    "Add emoji" : "Legg til emoji",
    "New collective name" : "Nytt gemenskapsnavn",
    ...
    "Add a page" : "Legg til en underside",
    "New Page" : "Ny side",
    ...
    "No collective selected" : "Ingen gemenskaper valgt",
    "Select a collective or create a new one on the left." : "Velg en gemenskap eller opprett en til venstre.",

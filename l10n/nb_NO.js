OC.L10N.register(
    ...
    "Share not found for user" : "Fant ikke siden:",
    ...
    "Could not change the collective share editing permissions" : "Kunne ikke opprette siden",
    ...
    "Name and emoji" : "Legg til emoji",
    "Select emoji for collective" : "Velg et kollektiv",
    "Default page order" : "Slett side",
    "Sort by title" : "Etter tittel",
    "Delete collective" : "Slettede kollektiver",
    "Add emoji" : "Legg til emoji",
    "Collectives Folder" : "Kollektiver",
    "Create a collective first" : "Opprett nytt kollektiv",
    "Select location for collectives" : "Velg et kollektiv",
    ...
    "Could not find the Page." : "Kunne ikke gi siden nytt navn",
    "Select a page from the list or create a new one." : "Velg et kollektiv, eller opprett ett til venstre.",
    ...
    "Done" : "Ferdig",
    "Edit" : "Rediger",
    "Hide all subpages" : "Legg til en underside",
    "Show all subpages" : "Legg til en underside",
    ...
    "No attachments available" : "Ingen andre versjoner tilgjengelig",
    "Could not get page attachments" : "Kunne ikke hente sideversjonering",

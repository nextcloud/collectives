OC.L10N.register(
    ...
    "Search users, groups, circles…" : "Felhasználók, csoportok, körök keresése…",
    "Add users, groups or circles…" : "Felhasználók, csoportok vagy körök hozzáadása",
    "Search for members to add" : "Hozzáadandó tagok keresése",
    "Loading…" : "Betöltés…",
    ...
    "Select a circle..." : "Válasszon egy kört…",
    "Select an existing circle" : "Válasszon egy meglévő kört",
    "Cancel selecting a circle" : "Kör kiválasztásának megszakítása",
    "Enter the new collective name or pick a circle" : "Adja meg az új kollektíva nevét, vagy válasszon egy kört",
    ...
    "Breadcrumb for Home" : "A Kezdőlap kenyérmorzsája",
    "Breadcrumb for {page}" : "A(z) {page} oldal kenyérmorzsája",
    ...
    "If the page has attachments, they will be listed here." : "Ha az oldalnak vannak mellékletei, akkor itt jelennek meg.",
    "Add attachments using drag and drop or via \"Insert attachment\" in the formatting bar" : "Adjon hozzá mellékleteket fogd és vidd módszerrel, vagy a „Melléklet beszúrása” gombbal a formázási sávon",

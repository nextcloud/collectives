OC.L10N.register(
    ...
    "Search users, groups, circles…" : "Търсене на потребители, групи, кръгове...",
    "Remove {name}" : "Премахване на {name}",
    "Search for members to add" : "Търсене на членове за добавяне",
    "Loading …" : "Зареждане …",
    ...
    "Select a circle..." : "Избор на кръг...",
    "Select an existing circle" : "Избор на съществуващ кръг",
    "Cancel selecting a circle" : "Отмяна на избора на кръг",
    "Enter the new collective name or pick a circle" : "Въвеждане на ново име на колектив или избор на кръг",
    "Add people" : "Добавяне на хора",
    "Back" : "Назад",
    "Create" : "Създаване",
    ...
    "Breadcrumb for Home" : "Breadcrumb /навигационен път/ за начална страница",
    "Breadcrumb for {page}" : "Breadcrumb /навигационен път/ за {page}",
    ...
    "No attachments available" : "Няма налични прикачени файлове",
    "If the page has attachments, they will be listed here." : "Ако страницата има прикачени файлове, те ще бъдат изброени тук.",
    "Add attachments using drag and drop or via \"Insert attachment\" in the formatting bar" : "Добавяне на прикачени файлове чрез плъзгане и пускане или чрез „Вмъкване на прикачен файл“ в лентата за форматиране",

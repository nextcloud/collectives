OC.L10N.register(
    ...
    "You're not part of a collective with that name." : "أنت لست جزءاً من تجميعة collective بذلك الاسم",
    ...
    "moderator" : "مُنسّق",
    "member" : "عضو",
    "Demote to moderator" : "خفض الرتبة إلى عضو",
    ...
    "Add users, groups or circles…" : "أضِف مستخدمِين أو مجموعات أو دوائر ...",
    ...
    "Admins only" : "المشرفين فقط",
    "Admins and moderators" : "المشرفين و المنسقين",
    ...
    "Breadcrumb for Home" : "مسار التنقل breadcrumb للصفحة الرئيسية ",
    "Breadcrumb for {page}" : "مسار التنقّل breadcrumb للصفحة {page}",
    ...
    "If the page has attachments, they will be listed here." : "إذا كان للصفحة مُرفقات، فستعرض قائمةٌ بها هنا",
    "Add attachments using drag and drop or via \"Insert attachment\" in the formatting bar" : "أضِف مُرفقاتٍ باستخدام السحُب و الإفلات أو عبر \"إدخال مُرفَق\" insert attachment  في شريط التنسيق formatting bar",

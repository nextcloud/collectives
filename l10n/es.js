OC.L10N.register(
    ...
    "Collectives - Page content" : "Cuadernos colectivos: contenido de la página",
    "in page {page} from collective {collective}" : "en la página {page} del cuaderno {collective}",
    "Collectives - Pages" : "Cuadernos colectivos: páginas",
    ...
    "Share not found for user" : "No se encontró la página:",
    ...
    "Could not change the collective share editing permissions" : "No se pudo crear la página",
    "Could not share the collective" : "No se pudo crear la página",
    "Could not unshare the collective" : "No se pudo renombrar la página",
    "Collective settings" : "Cuadernos",
    "Name and emoji" : "Cambiar emoji",
    "Select emoji for collective" : "Seleccionar cuaderno",
    "Default page order" : "Eliminar página",
    "Sort by title" : "Ordenar por título",
    "Permissions" : "Versiones",
    "Allow editing for" : "Parar de editar",
    "All members" : "Gestionar colaboradores",
    "Members" : "Gestionar colaboradores",
    "Delete collective" : "Cuadernos eliminados",
    "Change emoji" : "Cambiar emoji",
    "Add emoji" : "Añadir emoji",
    "Collectives Folder" : "Cuadernos",
    "Create a collective first" : "Crear nuevo cuaderno",
    "Select location for collectives" : "Seleccionar cuaderno",
    "Deleted collectives" : "Cuadernos eliminados",
    "Restore" : "Restablecer",
    ...
    "Create new collective" : "Crear nuevo cuaderno",
    "Create collective for existing circle" : "Crear cuaderno para círculo existente",
    "New collective name" : "Nombre del cuaderno nuevo",
    "Select circle..." : "Seleccionar círculo...",
    "Select a collective" : "Seleccionar cuaderno",
    ...
    "Select a page from the list or create a new one." : "Seleccionar una página de la lista o crear una nueva.",
    "Restore this version" : "Restablecer esta versión",
    "Reverted {page} to revision {timestamp}." : "Revertir {page} a la revisión {timestamp}.",
    ...
    "Done" : "Hecho",
    "Edit" : "Editar",
    "Hide all subpages" : "Ocultar todas las subpáginas",
    "Show all subpages" : "Mostrar todas las subpáginas",
    "Could not rename the page" : "No se pudo renombrar la página",
    "Expand subpage list" : "Expandir lista de subpáginas",
    "Collapse subpage list" : "Colapsar lista de subpáginas",
    ...
    "No attachments available" : "No hay enlaces entrantes",
    "Could not get page attachments" : "No se encontraron enlaces entrantes",
    ...
    "Please ask the administrator to enable these apps." : "Pida a la administadora de la nube que habilite estas aplicaciones."
},

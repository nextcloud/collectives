OC.L10N.register(
    ...
    "Left collective {name}" : "Vänster collective {name}",
    ...
    "Demote to member" : "Degradera till medlem",
    "Remove" : "Ta bort",
    "admin" : "admin",
    "moderator" : "moderator",
    "member" : "medlem",
    "Demote to moderator" : "Degradera till moderator",
    ...
    "Breadcrumb for page {name}" : "Brödsmula för sida {name}",

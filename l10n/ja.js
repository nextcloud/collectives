OC.L10N.register(
    ...
    "Share not found for user" : "ページが見つかりません:",
    ...
    "Could not change the collective share editing permissions" : "ページを作成できません",
    "Could not share the collective" : "ページを作成できません",
    "Could not unshare the collective" : "ページ名を変更できません",
    "Collective settings" : "コレクティブ",
    "Name and emoji" : "絵文字の変更",
    "Select emoji for collective" : "コレクティブの場所を選択",
    "Default page order" : "ページの削除",
    "Sort by title" : "タイトルでソート",
    "Permissions" : "バージョン",
    "Allow editing for" : "編集終了",
    "All members" : "メンバーの管理",
    "Members" : "メンバーの管理",
    "Delete collective" : "コレクティブの削除",
    "Change emoji" : "絵文字の変更",
    "Add emoji" : "絵文字の追加",
    ...
    "Done" : "完了",
    "Edit" : "編集",
    "Hide all subpages" : "すべてのサブページを隠す",
    "Show all subpages" : "すべてのサブページを表示",
    "Could not rename the page" : "ページ名を変更できません",
    "Expand subpage list" : "サブページリストを開く",
    "Collapse subpage list" : "サブページリストを閉じる",
    ...
    "Sort order" : "ソート順",
    "Add a page" : "ページの追加",
    "No attachments available" : "バックリンクはありません",
    "Could not get page attachments" : "バックリンクが取得できません",

OC.L10N.register(
    ...
    "Left collective {name}" : "Zapustili ste zbirko {name}",
    ...
    "Search users, groups, circles…" : "Iskanje uporabnikov, skupin, krogov ...",
    "Remove {name}" : "Odstrani {name}",
    "Search for members to add" : "Poišči člane za dodajanje",
    ...
    "Select a circle..." : "Izbor kroga ...",
    "Select an existing circle" : "Izbor obstoječega kroga",
    "Cancel selecting a circle" : "Prekliči izbiro kroga",
    "Enter the new collective name or pick a circle" : "Izberite ime nove zbirke in izberite krog",
    "Add people" : "Dodaj osebe",
    "Back" : "Nazaj",
    "Create" : "Ustvarjeno",
    ...
    "No attachments available" : "Ni razpoložljivih prilog",
    "If the page has attachments, they will be listed here." : "Če se na to stran povezujejo priloge, bodo izpisane na tem mestu.",

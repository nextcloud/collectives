OC.L10N.register(
    ...
    "PDO SQLite driver" : "راننده PDO SQLite",
    "PDO SQLite driver is enabled, full text search of page content is available." : "راننده PDO SQLite روشن شده است، جستجوی کامل متن محتوای برگه در دسترس است.",
    "Collectives app is enabled, but PDO SQLite driver is missing. Please install it to enable full text search of the page content." : "برنامه انجمن‌ها روشن شده است، اما راننده PDO SQLite نیست. لطفاً آن را نصب کنید تا جستجوی کامل متن محتوای برگه به‌کار افتد.",
    ...
    "Renaming is limited to owners of the team" : "ویرایش نام تنها برای مالکان گروه ممکن است",
    ...
    "Breadcrumb for page {page}" : "مسیر برگه {page}",
    ...
    "Results in title" : "نتایج در عنوان",

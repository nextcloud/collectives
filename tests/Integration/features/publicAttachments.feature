...
Feature: publicAttachments
  ...
  Scenario: Upload, rename delete and restore page attachment in public share
    ...
    When anonymous restores deleted attachment for page "first" in public collective "BehatPublicAttachmentsCollective" with owner "jane"
    Then anonymous sees attachment "renamed.png" with mimetype "image/png" for "first" in public collective "BehatPublicAttachmentsCollective" with owner "jane"

  Scenario: Not allowed to upload, rename, delete and restore page attachment for read-only user in public share
    ...
    When user "jane" deletes attachment "test.png" for page "first" in "BehatPublicAttachmentsCollective"
    Then anonymous fails to restore deleted attachment for page "first" in public collective "BehatPublicAttachmentsCollective" with owner "jane"
